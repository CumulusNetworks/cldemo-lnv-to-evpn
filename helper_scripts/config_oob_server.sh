...
wget -q https://repo3.cumulusnetworks.com/repo/pool/cumulus/c/cumulus-archive-keyring/cumulus-archive-keyring_3-cl3u4_all.deb
...
git clone -b lnv-to-evpn https://github.com/CumulusNetworks/cldemo-lnv-to-evpn lnv-to-evpn
